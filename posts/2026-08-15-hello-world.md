...
I don't know how my blog implementation is, though. I went off a reddit thread where they talked about using markdown files to populate blog posts, but i'm not experienced enough about web dev to know if this is a good way or not.
